...
//! (neo4j-rs), and similarity engine (ladybug-rs).
//!
//! # Tool Inventory
//!
...
//! | `chess_legal_moves` | stonksfish | Tactician, Critic, Advocatus Diaboli |
//! | `neo4j_query` | neo4j-rs | Strategist, Endgame, Psychologist, Advocatus Diaboli |
